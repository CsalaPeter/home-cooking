...
export class CreateRecipeTable1754894814643 implements MigrationInterface {
    name = 'CreateRecipeTable1754894814643'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ingredient" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "calories" smallint NOT NULL, "fat" numeric(4,1) NOT NULL, "carbs" numeric(4,1) NOT NULL, "protein" numeric(4,1) NOT NULL, "fiber" numeric(4,1) NOT NULL, CONSTRAINT "UQ_b6802ac7fbd37aa71d856a95d8f" UNIQUE ("name"), CONSTRAINT "PK_6f1e945604a0b59f56a57570e98" PRIMARY KEY ("id"))`);
