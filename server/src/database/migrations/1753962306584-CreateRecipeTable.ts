...
export class CreateRecipeTable1753962306584 implements MigrationInterface {
    name = 'CreateRecipeTable1753962306584'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "recipe" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "image" character varying NOT NULL, "description" character varying NOT NULL, "instructions" character varying array NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e365a2fedf57238d970e07825ca" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "measurement" ("id" SERIAL NOT NULL, "unit" character varying NOT NULL, CONSTRAINT "UQ_63d975b1ebd36c7b8cd5e625941" UNIQUE ("unit"), CONSTRAINT "PK_742ff3cc0dcbbd34533a9071dfd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "recipeIngredient" ("id" SERIAL NOT NULL, "amount" numeric(10,2) NOT NULL, "recipe_id" integer, "measurement_id" integer, "ingredient_id" integer, CONSTRAINT "PK_2249df92bb650fad022399b0e8e" PRIMARY KEY ("id"))`);
